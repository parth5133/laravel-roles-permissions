!(function (t, e) {
    ...
    n = {
      ...
      arrayDiff: function (t, e) {
        ...
        for (r = 0, i = e.length; r < i; ++r)
          (a = e[r]),
            -1 === (n = o.indexOf(a)) ? l.push([a, 1]) : o.splice(n, 1);
      ...
      e.clamp &&
        (a = (function (t, e) {
          for (
            ...
            (r = x || y) & u
              ? ((n = a + ((c - a) * (e.top - f)) / (h - f)), (i = e.top))
              : r & s
              ? ((n = a + ((c - a) * (e.bottom - f)) / (h - f)), (i = e.bottom))
              : r & l
              ? ((i = f + ((h - f) * (e.right - a)) / (c - a)), (n = e.right))
              : r & o &&
                ((i = f + ((h - f) * (e.left - a)) / (c - a)), (n = e.left)),
              r === x
                ? (x = d((a = n), (f = i), e))
                : (y = d((c = n), (h = i), e));
  ...
  var c = {
      ...
      rect: function (t, e) {
        ...
        return (
          t.horizontal
            ? ((n = Math.min(t.x, t.base)), (o = Math.abs(t.base - t.x)))
            : ((a = Math.min(t.y, t.base)), (l = Math.abs(t.base - t.y))),
          f({ x0: n, y0: a + l, x1: n + o, y1: a, vx: r.x, vy: r.y }, e)
        );
      },
      fallback: function (t, e) {
        var r = i(t, e.origin);
        return f({ x0: t.x, y0: t.y, x1: t.x, y1: t.y, vx: r.x, vy: r.y }, e);
      },
    },
    h = t.helpers,
    x = n.rasterize;
  ...
  b.extend(M.prototype, {
    ...
    intersects: function (t) {
      ...
      for (
        this._rotation !== t._rotation && o.push(k(a[0], a[1]), k(a[0], a[3])),
          e = 0;
        e < o.length;
        ++e
      )
        if (
          ((r = w(i, o[e])), (n = w(a, o[e])), r.max < n.min || n.max < r.min)
        )
          return !1;
      return !0;
    },
  ...
  var C = {
      prepare: function (t) {
        ...
        return (
          o.sort(function (t, e) {
            var r = t.$layout,
              n = e.$layout;
            return r._idx === n._idx ? r._set - n._set : n._idx - r._idx;
          }),
          this.update(o),
          o
        );
      ...
      update: function (t) {
        ...
        for (e = 0, r = t.length; e < r; ++e)
          (i = (n = t[e]).model()),
            ((a = n.$layout)._hidable = i && "auto" === i.display),
  ...
  var N = {
    ...
    afterDatasetUpdate: function (t, e, r) {
      var n,
        ...
        f = (function (t, e) {
          var r = t.datalabels;
          return !1 === r ? null : (!0 === r && (r = {}), O.merge({}, [e, r]));
        })(d, r),
        c = e.meta.data || [],
        h = c.length,
        x = t.ctx;
      ...
      x.restore(),
        O.merge(l._listeners, f.listeners || {}, {
          merger: function (t, r, n) {
            (r[t] = r[t] || {}), (r[t][e.index] = n[t]), (l._listened = !0);
          },
        });
    },
    ...
    afterEvent: function (e) {
      ...
      for (r = 0, i = d.length; r < i; ++r)
        (a = d[r])[1] &&
          (o = a[0][D]) &&
          ((o.$context.active = 1 === a[1]), o.update(o.$context));
      (l._dirty || d.length) &&
        (C.update(l._labels),
        (function (e) {
          if (!e.animating) {
